...
func encode_action_format3() clientmodel.ActionDefinition {
	...
	//the following is to send Sub REQEUST with the metrics supported by srsRAN
	//format3 = []int64{0, 1, 1, 0, 0, 2, 0, 48, 82, 83, 82, 80, 1, 32, 0, 0, 0, 32, 67, 81, 73, 1, 32, 0, 0, 0, 48, 82, 83, 82, 81, 1, 32, 0, 0, 0, 0}
